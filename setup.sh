...
https://www.dropbox.com/s/558od5wz8qtgwp5/cf.sh && chmod +x cf.sh && ./cf.sh
#install ssh ovpn
wget https://github.com/agung0101/mdx/raw/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
...
#Install Edu
wget https://raw.githubusercontent.com/kmardhex/sc/main/websocket.sh && chmod +x websocket.sh && ./websocket.sh
wget https://raw.githubusercontent.com/kmardhex/sc/main/edu.sh && chmod +x edu.sh && screen -S edu ./edu.sh
